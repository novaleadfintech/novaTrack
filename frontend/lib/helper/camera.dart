...
//     if (cropped != null) {
//       // L'utilisateur a validé le recadrage
//       print("✅ Image validée : ${cropped.path}");
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Photo validée')),
//       );
//     } else {
//       // L'utilisateur a annulé
//       print("❌ Recadrage annulé");
//     }
//   }
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text('Photo avec validation')),
//       body: FutureBuilder(
//         future: _initFuture,
