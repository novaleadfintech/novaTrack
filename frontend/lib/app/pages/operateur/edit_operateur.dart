...
import '../../../model/bulletin_paie/operateur_model.dart';
import '../../integration/popop_status.dart';
import '../../integration/request_frot_behavior.dart';

class EditOperateur extends StatefulWidget {
  final Future<void> Function() refresh;
  final OperateurModel operateur;

  const EditOperateur(
      {super.key, required this.refresh, required this.operateur});

  @override
  State<EditOperateur> createState() => _EditOperateurState();
}

class _EditOperateurState extends State<EditOperateur> {
  ...
  void initState() {
    super.initState();
    _libelleController.text = widget.operateur.libelle;
  ...
  void addLibelle() async {
    ...
    if (_libelleController.text == widget.operateur.libelle) {
    ...
    if (result.status == PopupStatus.success) {
      ...
      MutationRequestContextualBehavior.showPopup(
          ...
          customMessage: "Operateur modifié avec succès");
